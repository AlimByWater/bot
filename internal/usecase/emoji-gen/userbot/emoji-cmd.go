...
//	//args := processing2.ExtractCommandArgs(update.EffectiveMessage.Text, "")
//	//emojiArgs, err := processing2.ParseArgs(args)
//	//if err != nil {
...
//	//processing2.SetupEmojiCommand(emojiArgs, update.EffectiveChat().GetID(), update.GetUserChat().Username)
//	//
...
//	//// ++++++++++++++++++++++++++++++++++++++++++++++++++++++
//	//
//	//emojiPack, err := processing2.SetupPackDetails(ctx, emojiArgs, dripBot.BotUserName())
//	//if err != nil {
...
//	//	// Обрабатываем видео
//	//	createdFiles, err := processing2.ProcessVideo(ctx, emojiArgs)
//	//	if err != nil {
...
//	//			//messagesToDelete.Store(update.ProgressMessage.From.ID, update.ProgressMessage.ID)
//	//			return err
//	//
//	//		}
//	//
...
//	//selectedEmojis := processing2.GenerateEmojiMessage(emojiMetaRows, stickerSet, emojiArgs)
...
func (u *User) sendMessageWithEmojisInDM(ctx *ext.Context, update *ext.Update, width int, packLink string, emojis []entity.EmojiMeta) error {
...
func (u *User) prepareWorkingEnvironment(ctx *ext.Context, update *ext.Update, args *entity.EmojiCommand) error {
	// +++++++ FILE ++++++++
...
//func (u *User) chooseBot(emojiArgs *entity.EmojiCommand) *bots2.DripBot {
//	var dripBot *bots2.DripBot
//	if emojiArgs.PackLink == "" {
//		dripBot = bots2.Manager.GetBotByUsername(entity.VIP_BOT_USERNAME)
//	} else {
//		if strings.Contains(emojiArgs.PackLink, entity.VIP_BOT_USERNAME) {
//			dripBot = bots2.Manager.GetBotByUsername(entity.VIP_BOT_USERNAME)
//		} else if strings.Contains(emojiArgs.PackLink, entity.BOT_USERNAME) {
//			dripBot = bots2.Manager.GetBotByUsername(entity.BOT_USERNAME)
//		} else if strings.Contains(emojiArgs.PackLink, entity.TEST_BOT_USERNAME) {
//			dripBot = bots2.Manager.GetBotByUsername(entity.TEST_BOT_USERNAME)
//		}
//	}
//
//	return dripBot
